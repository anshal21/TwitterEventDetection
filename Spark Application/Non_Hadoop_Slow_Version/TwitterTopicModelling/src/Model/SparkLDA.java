...
//        SparkConf conf = new SparkConf().setAppName("SparkLDA");
//        JavaSparkContext sparkContext = new JavaSparkContext(conf);
        JavaRDD<String> data = sparkContext.textFile(Document.ProjectConstants.LdaSrcDirectory+outputFile+"input.LDA");
      ...
      + " words):");
        ...
        File file = new File(Document.ProjectConstants.LdaSrcDirectory+"output"+outputFile);
        file.createNewFile();
